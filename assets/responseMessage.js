module.exports = {
    ...
    MARK_FAV: 'Business marked as favorite',
    MARK_UNFAV: 'Business removed from your favorite list',
    RESERVATION_SUCCESSFUL: 'Please Check Your Notifications for Confirmation',
    ...
    CATEGORY_PAGE_ADDED: 'Your Changes have been Saved',
    CATEGORY_PAGE_UPDATED: 'Your Changes have been Saved',
    ...
    FAV_BUSINESS_NOT_FOUND: 'You have not marked any business as favorite',
    ...
    DOMAIN_UPDATED: 'Your Changes have been Saved',
    ...
    EVENT_CAHNGED_SPECIAL: 'Event changed to special successfully',
    SPECIAL_CAHNGED_EVENT: 'Special changed to event successfully',
    BUSINESS_LSITING_TO_PROFILE: 'Businesses converted from listing to profile successfully',
    BUSINESS_PROFILE_TO_LSITING: 'Businesses converted from profile to listing successfully',
    ALL_BUSINESS_LIVE: 'All business has been set to live successfully',
    DOMAIN_CREATED: 'New Website created successfully'
